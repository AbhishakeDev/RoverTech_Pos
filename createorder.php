                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Customer Name" name="txtcustomer" required>
                        </div>
                    </div>
                    <!-- /.col-md-6 -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div id="datepicker" class="input-group date" data-date-format="yyyy-mm-dd">
                                <input data-date-format="yyyy-mm-dd" value="<?php echo date("Y-m-d"); ?>" name="orderdate" class="form-control" type="text"/>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" value="cash" name="rb" checked>
                        <label for="radioPrimary1">Cash
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" value="card" name="rb">
                        <label for="radioPrimary2">Card
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary3" value="check" name="rb">
